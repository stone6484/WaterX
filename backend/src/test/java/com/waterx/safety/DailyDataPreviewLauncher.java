...
public final class DailyDataPreviewLauncher {
    public static void main(String[] args)throws Exception{
        ...
        System.setProperty("server.address","127.0.0.1");System.setProperty("server.port","8083");
        ...
        System.setProperty("app.storage.local-dir","/private/tmp/waterx-personnel-impl/attachments");
        ...
        Path file=Path.of("/private/tmp/waterx-personnel-impl/preview-access.json");Files.createDirectories(file.getParent());
        ...
        System.out.println("DAILY_DATA_PREVIEW_READY http://127.0.0.1:8083");Thread.currentThread().join();
    }
}
