...
(function () {
  'use strict';
  window.WaterXDetailModels = function (api) {
    ...
    return {build(g,e,base){const fn=builders[e.kind];return fn?fn(g,e,base):independent(rounded(g,0,-.20,0,2.1,1.7,1.7,base));}};
  };
})();
