...
$('detailReveal').addEventListener('pointerenter',e=>{if(e.pointerType==='mouse')setDrawer(true,drawerPinned);});
...
$('resetView').onclick=()=>{
 ...
 document.querySelectorAll('[data-tab]').forEach(b=>{const on=b.dataset.tab==='asset';b.classList.toggle('active',on);b.setAttribute('aria-selected',String(on));});
